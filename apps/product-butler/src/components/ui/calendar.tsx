...
import { supportedLanguage } from "@/production/core/i18n/locale";
...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  ...
  const language = supportedLanguage(bootstrap.locale);
  ...
  return (
    <DayPicker
      ...
      locale={locale}
      labels={{
        labelMonthDropdown: () => __("Choose month", "yaxii-product-workspace"),
        labelNext: () => __("Go to next month", "yaxii-product-workspace"),
        labelPrevious: () => __("Go to previous month", "yaxii-product-workspace"),
        labelYearDropdown: () => __("Choose year", "yaxii-product-workspace"),
      }}
