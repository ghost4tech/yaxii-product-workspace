  ...
  return <div className={cn(
    ...
    <div className="flex flex-wrap items-center gap-2 px-3 py-2">
      <div className="flex min-w-0 flex-1 basis-[10rem] items-center gap-2">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-1">{labels.map((label, labelIndex) => <span key={`${label}-${labelIndex}`} className="contents">
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2">
        ...
        <div className="input-group w-[7.5rem] shrink-0">
          <span className="input-affix">{currency}</span>
          <input type="number" step="0.01" inputMode="decimal" placeholder={__("Sale price", "yaxii-product-workspace")} className="font-mono" dir="ltr"
